    ...
    <>
      <div className="suggest-info-slider">
        ...
        <div className='suggest-info-slider_controls'>
          <button className='suggest-info-slider_controls-button suggest-info-slider_description-button-prev'>
            <ArrowLeft className='suggest-info-slider_controls-icon' />
          </button>
          <button className='suggest-info-slider_controls-button suggest-info-slider_description-button-next'>
