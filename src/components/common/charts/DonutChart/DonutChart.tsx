  ...
  return (
    <div className={classNames("donutChart_container", {
      ...
      <svg className="donutChart" width="34" height="34" viewBox="0 0 34 34">
        ...
        <circle className="donutChart__circle" cx="17" cy="17" r="16"></circle>
        <circle className="donutChart__circle-paint" cx="17" cy="17" r="16" stroke={`url(#gradient-${gradientId})`} stroke-dasharray={`${percent} 100`}></circle>
      </svg>
    </div>
  );
};
