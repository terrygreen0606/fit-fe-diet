...
const MainView = () => {
  const setFile = (e) => {
    axios
      .post('https://fitdev.s3.amazonaws.com', {
        'X-Amz-Credential':
          'AKIAVC4WRCO73AU6DZGV/20200716/us-east-1/s3/aws4_request',
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-6'>
              ...
              <p>
                sulle ja su perele sulle ja su perelesulle ja su perelesulle ja
                su perelesulle ja su perelesulle ja su perelesulle ja su
                perelesulle ja su perelesulle ja su perele
              </p>
            ...
            <div className='col-6'>
              <div className='main-header-sect-img-wrap'>
                ...
                <img
                  ...
                  alt=''
                  id='main-header-sect-food-img1'
                />
                <img
                  src='https://fitstg.s3.eu-central-1.amazonaws.com/food-serving-img-1.png'
                  alt=''
                  id='main-header-sect-food-img2'
                />
              </div>
            </div>
          </div>
          ...
          <div className='row'>
            <div className='col-3'>
              <div className='main-features-sect-img-wrap'>
                ...
                <img
                  src='https://fitstg.s3.eu-central-1.amazonaws.com/sport-woman.png'
                  alt=''
                  id='main-features-sect-img'
                />
              </div>
            </div>
            <div className='col-9'>
              ...
              <p>
                Eating is the most important thing to get in shape. When you eat
                healthily and are physically active, your weight is under
                control and your health improves. When you eat according to the
                simple and delicious recipes of Fitlap, you will feel healthy
                and fresh.
              </p>
              ...
              <div className='main-diet-plan-feature-list'>
                <div className='main-diet-plan-feature-list-item'>
                  <span
                    className='main-diet-plan-feature-icon'
                    style={{
                      backgroundImage: `url('https://fitstg.s3.eu-central-1.amazonaws.com/nutrition-feature.png')`,
                    }}
                  ></span>
                  ...
                  <div className='main-diet-plan-feature-content'>
                    ...
                    <p>
                      With Fitlap you dont have to give up on any of your
                      favourite foods!
                    </p>
                  </div>
                </div>
                ...
                <div className='main-diet-plan-feature-list-item'>
                  <span
                    className='main-diet-plan-feature-icon'
                    style={{
                      backgroundImage: `url('https://fitstg.s3.eu-central-1.amazonaws.com/list-feature.png')`,
                    }}
                  ></span>
                ...
                <div className='main-diet-plan-feature-list-item'>
                  <span
                    className='main-diet-plan-feature-icon'
                    style={{
                      backgroundImage: `url('https://fitstg.s3.eu-central-1.amazonaws.com/graph-feature.png')`,
                    }}
                  ></span>
            ...
            <div className='col-3'>
              <div className='main-success-story-item'>
                <div
                  ...
                  style={{
                    backgroundImage: `url('https://fitstg.s3.eu-central-1.amazonaws.com/sport-woman-gym.jpg')`,
                  }}
                ></div>

                <h6 className='main-success-story-item-name'>
                  Jaanika Paimre, 47
                </h6>

                <div className='main-success-story-item-content'>
                  <h6 className='main-success-story-item-title'>
                    -38kg with plan
                  </h6>
                  <p className='main-success-story-item-descr'>
                    Jaanika is a 47-year-old mother of five children who lost 38
                    extra pounds and 104 cmi of her whole body with the help of
                    a diet plan.
                  </p>
                </div>
              </div>
